...
export default function Home() {
  ...
  const filtered = useMemo(() => {
    ...
    const result = visibleRecipes.filter((recipe) => {
      ...
      return matchesQuery && matchesCategory && matchesProtein && matchesVegetarian && matchesTaste && matchesPantry;
    });
  ...
  }, [category, favorites, pantry, pantryMode, proteinOnly, query, sort, taste, vegetarianOnly, visibleRecipes]);
