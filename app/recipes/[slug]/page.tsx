...
export default async function RecipePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="site-shell detail-shell">
    ...
    <article className="recipe-detail">
      ...
      <div className="detail-metrics"><span><b>{recipe.nutrition.protein}g</b> protein</span><span><b>{recipe.nutrition.calories}</b> calories*</span><span><b>{recipe.totalMinutes} min</b> total</span><span><b>{recipe.yield.amount}</b> {recipe.yield.label}</span></div>
