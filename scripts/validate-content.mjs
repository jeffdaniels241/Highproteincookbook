...
const expected = { Bread: 28, 'RC-Breads': 22, 'RC-Breakfast': 7, 'Rice-Cooker': 29, 'High-Protein': 32, 'Sides & Snacks': 9 };
const errors = [...validateRecipes()];
if (recipes.length !== 127) errors.push(`expected 127 normalized recipes, found ${recipes.length}`);
...
if (rice.length !== 58) errors.push(`expected 58 rice-cooker records, found ${rice.length}`);
...
const marinade = special('quick protein marinades');
